...
//    uint8_t addr_rx3[5];
    ...
    char msg[223]="Intersection-0 Sender-RSU1    Road-1 TotalRoads-4 MsgType-0 Speed-50MPH Lane-2 Length-4m Class-2 Length-   Class-  Weight-      Warnings: Speeding-Y Water-N Ice-N LowVisibility-Y EmergencyVechiel-N DamagedRoad-N ID-00000009";
...
//send_msg();
  ...
  // display msg. 1. type 0 rcvd, 2. type 1 sent 3. type 2 rcvd 4. type 3 sent 5. type 3 rcvd
        if(buf_r[2] == 0)  // if rcvd message type is 0
        {
            ...
            buf_s[11] = 5;  // random number generated by vehicle to complete the final ID for vehicle
            buf_s[12] = buf_r[12];
            buf_s[13] = buf_r[13];
...
void createmsg0(){
    ...
    // new ID = 5*2^16+9, 5 is random number generated by vehicle and 9 is ID sent from RSU
    msg[217] = '0';
    msg[218] = '0';
    msg[219] = '0';
    msg[220] = '0';
