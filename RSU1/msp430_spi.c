 ...
 * an internal char * pointer to manipulate the individual 8-bit segments of a
 * 16-bit integer.
 */
...
{
	int retw;
	char *retw8 = (char *)&retw, *inw8 = (char *)&inw;
...
int spi_transfer9(int inw)
{
	char p1dir_save, p1out_save, p1ren_save;
	int retw=0;
...
int spi_transfer9(int inw)
{
	char p3dir_save, p3out_save, p3ren_save;
	int retw=0;
...
{
	char p3dir_save, p3out_save, p3ren_save;
	char p2dir_save, p2out_save, p2ren_save;
	int retw=0;
...
int spi_transfer9(int inw)
{
	char p5dir_save, p5out_save, p5ren_save;
	int retw=0;
